    ...
    <div class="container">
        ...
        <div class="front-page">
            ...
            <section class="section-1">
                    ...
                    <nav class="navbar">
                        ...
                        <ul class="nav-list">
                            <li class="nav-list-item dropdown-hover">
                                <a href="/a/individuals" class="nav-list-link show-dropdown">Personal <i
                                ...
                                <ul class="nav-dropdown nav-dropdown-personal">
                                    ...
                                    <li class="nav-dropdown-item">
                                        <a href="/a/individuals" class="nav-dropdown-link-1">Send payments</a>
                                        <a href="/a/individuals" class="nav-dropdown-link-2">Send payments abroad</a>
                                    </li>
                            ...
                            <li class="nav-list-item dropdown-hover">
                                <a href="/a/businesses" class="nav-list-link show-dropdown">Business <i
                                        class="fas fa-chevron-down"></i></a>
                                <ul class="nav-dropdown nav-dropdown-business">
                                    <li class="nav-dropdown-item dropdown-heading">
                                        <a href="/a/businesses" class="dropdown-heading-link">
                                            <i class="fas fa-chevron-down"></i> Business
                                        </a>
                                    </li>
                                    <li class="nav-dropdown-item">
                                        <a href="/a/businesses" class="nav-dropdown-link-1">Accept online payments</a>
                                        <a href="/a/businesses" class="nav-dropdown-link-2">Get paid on your website</a>
                                    </li>

                                </ul>
                            </li>
                            <li class="nav-list-item dropdown-hover">
                                <a href="/a/#" class="nav-list-link show-dropdown">Partners and Developers <i
                                        class="fas fa-chevron-down"></i></a>
                                <ul class="nav-dropdown nav-dropdown-personal">
                                    <li class="nav-dropdown-item dropdown-heading">
                                        <a href="#" class="dropdown-heading-link">
                                    ...
                                    <li class="nav-dropdown-item">
                                        <a href="#" class="nav-dropdown-link-1">Danny Safaya</a>
                                        <a href="#" class="nav-dropdown-link-1">laith Tabliea</a>
                                    </li>
                        ...
                        <div class="navbar-buttons"><a href="/a/login/"><button class="navbar-btn login-btn login">Login</button></a>
                ...
                <div class="banner">
                    <h1 class="banner-heading">your Best Choice</h1>
                    <p class="banner-paragraph">You will facilitate the transfer your funds via the Internet through the
                        electronic payment
                        gateway.</br>Your security is important to us.</p>
                    <a href="/a/learnmore"><button class="blue-btn">Learn More</button></a>
                </div>
            </section>
            <!-- End of Section 1 -->
            ...
            <section class="section-2">
                ...
                <div class="services">
                    <div class="service">
                        ...
                        <p class="service-paragraph">You can receive your funds or pay.</p>
                        <a href="individuals"><button class="service-btn">Learn More</button></a>
                    </div>
                    <div class="service">
                        <i class="fas fa-briefcase"></i>
                        <h3 class="service-heading">Businesses</h3>
                        <p class="service-paragraph">Accepting multiple payment methods like credit cards and mobile
                            payment apps.</p>
                            <a href="businesses"><button class="service-btn">Learn More</button></a>
                    </div>
            ...
            <section class="section-3">
                <h1 style="width: max-content;margin: 0 auto 1rem auto;"class="section-3-heading">The world prefers </br>PaymentGateway</br></h1>
                <div class="features">
                    <div class="feature">
                        <h3 class="feature-heading">Advanced Protection</h3>
                        <p class="feature-paragraph">We use the Global protection standards.</p>
                    </div>
                    <div class="feature">
                        <h3 class="feature-heading">Fast Payments</h3>
                        <p class="feature-paragraph">Fast is needed to make you feel good.</p>
                    </div>
                    <div class="feature">
                        <h3 class="feature-heading">Global Reach</h3>
                        <p class="feature-paragraph">Out service is used by a large numbers of people.</p>
                    </div>
                    <div class="feature">
                        <h3 class="feature-heading">Easy Integration</h3>
                        <p class="feature-paragraph">Easy to use.</p>
                    </div>
                    <div class="feature">
                        <h3 class="feature-heading">Simple and Convenient</h3>
                        <p class="feature-paragraph">No thing will be hard.</p>
                    </div>
                    <div class="feature">
                ...
                <div class="section-4-content">
                    ...
                    <ul class="section-4-list">
                        <li class="section-4-list-item">
                            ...
                            <span>Set up <a href="/a/c">a business account</a></span>
                        </li>
                        <li class="section-4-list-item">
            ...
            <section class="section-5">
                <div class="section-5-top">
                    ...
                    <a href="/a/c"><button class="blue-btn signup">Get Started</button></a>
                </div>
                <footer class="footer">
